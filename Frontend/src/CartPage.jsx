        ...
        handler: async function (response) {
          try {
            ...
            if (verifyResponse.ok) {
              ...
              navigate("/orders"); // Redirect to Customer Home Page
            } else {
...
if (cartItems.length === 0) {
    return (
      <div className="cart-page empty" style={{ textAlign: 'center', padding: '40px' }}>
    ...
    <div style={{ width: "100vw" }}>
      ...
      <div className="cart-container">
        <div className="cart-page">
          <a href="/listings" className="back-button">
            ← Shopping Continue
          </a>
